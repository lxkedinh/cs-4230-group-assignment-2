...
def read_graph() -> nx.Graph:
    '''
        ...
        Returns:
        - Largest connected component of the NetworkX graph represented in the Twitter or Facebook file
    '''
    ...
    # Extract largest connected component for main part of graph
...
def parallel_closeness(G: nx.Graph) -> dict:
    '''
...
def get_top_closeness(closeness: dict):
    '''
...
def get_average_closeness(closeness: dict):
    '''
